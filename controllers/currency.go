...
// CurrencyController operations for Currency
type CurrencyController struct {
	beego.Controller
}

// URLMapping ...
func (c *CurrencyController) URLMapping() {
...
// @Param	body		body 	models.Currency	true		"body for Currency content"
...
// @router /:id [get]
func (c *CurrencyController) GetOne() {
...
// Delete ...
// @Title Delete
// @Description delete the Currency
